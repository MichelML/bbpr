...
function presentInfoReview (destinationBranch, pullRequestTitle, pullRequestDescription, allReviewers, usernameBitBucketAPI, usernameBitBucket) {
  let infoReview = reviewStrings.infoReviewStart.magenta
  infoReview += `${reviewStrings.usernameAPI.bold.cyan}${usernameBitBucketAPI}\n`
