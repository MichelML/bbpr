...
module.exports = function presentInfoReview (destinationBranch, pullRequestTitle, pullRequestDescription, allReviewers, usernameBitBucket) {
  let infoReview = '\n========PULL REQUEST SUMMARY START==========\n'.magenta

  infoReview += `${'USERNAME:\n'.bold.cyan}${usernameBitBucket}\n`
  infoReview += `${'PASSWORD:\n'.bold.cyan}(hidden)\n`
