module.exports = {
  ...
  cal: 'aes192',
  config: {
    reset: 'Are you sure you want to set your configuration file to the one specified (y/n)?',
  ...
  prompt: {
    bitBucketUserNameAPI: 'bitbucket username or company name under which your repository is located: \n',
