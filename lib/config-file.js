...
function resetConfig () {
  co(function * () {
    ...
    if (shouldReset) {
      shell.cp(`${__dirname.replace(/lib$/, 'config_presets')}/reset.js`, `${__dirname.replace(/lib$/, '')}/bbpr.config.js`)
    }
...
function setAllTrueConfig () {
  co(function * () {
    ...
    if (shouldReset) {
      shell.cp(`${__dirname.replace(/lib$/, 'config_presets')}/all-true.js`, `${__dirname.replace(/lib$/, '')}/bbpr.config.js`)
    }
