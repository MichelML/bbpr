...
const getConfigFlag = require('./terminal-options').getConfigFlag
const terminalOptionFlags = require('./terminal-options').terminalOptionFlags
...
function resetConfig () {
  co(function * resetConfigGenerator () {
...
function setTailoredConfig (pathToFile) {
  co(function * setTailoredConfigGenerator () {
    console.log(`${configStrings.noBackup}`.yellow.bold)
    const shouldReset = yield prompt.confirm(`${configStrings.reset}`.bold)
...
function setRemoteConfig (pathToFile) {
  co(function * setRemoteConfigGenerator () {
    console.log(`${configStrings.noBackup}`.yellow.bold)
    const shouldReset = yield prompt.confirm(`${configStrings.reset}`.bold)
